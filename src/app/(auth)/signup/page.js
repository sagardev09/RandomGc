                            ...
                            <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-6">
                                <div className="col-span-6 sm:col-span-3">
                                    ...
                                    <input
                                        ...
                                        id="FirstName"
                                        name="first_name"
                                        className="mt-1 w-full border p-3 rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
                                ...
                                <div className="col-span-6">
                                    ...
                                    <input
                                        ...
                                        className="mt-1 border p-3 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
                                        placeholder='Email'
